...
public class DomicilioService implements BaseService<DomicilioDTO> {
    ...
    @Override
    @Transactional
    public List<DomicilioDTO> findAll() throws DomicilioException {
        try {
            List<DomicilioDTO> domicilios = domicilioMapper.toDTOsList(domicilioRepository.findAll());
            return domicilios;
        }catch (Exception e){
            throw new DomicilioException(e.getMessage());
        }
    }

    @Override
    @Transactional
    public DomicilioDTO findById(Long id) throws DomicilioException {
        try{
    ...
    @Override
    @Transactional
    public DomicilioDTO update(DomicilioDTO dto, Long id) throws DomicilioException {
        try{
            ...
            throw new DomicilioException("No existe un domicilio con el id: " + id);
        }catch (Exception e){
            throw new DomicilioException(e.getMessage());
        }
    }
    ...
    @Override
    @Transactional
    public DomicilioDTO save(DomicilioDTO dto) throws DomicilioException {
        try{
            Domicilio entity = domicilioMapper.toEntity(dto);
    ...
    @Override
    @Transactional
    public boolean deleteById(Long id) throws DomicilioException {
        try{
            Optional<Domicilio> opt=this.domicilioRepository.findById(id);
            if(!opt.isEmpty()){
                Domicilio domicilio=opt.get();
